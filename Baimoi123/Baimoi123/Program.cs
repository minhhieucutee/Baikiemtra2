...

{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            products[3] = new MobilePhone("M001", "Phone 97", 5500.21, "Apple");
            products[4] = new MobilePhone("M002", "SamSung 99 ", 801.124, "SamSung");
            products[5] = new MobilePhone("M003", "Oppo 990", 1203.345, "Oppo");
